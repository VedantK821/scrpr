...
export function Topbar({ onToggleSidebar, sidebarCollapsed }: TopbarProps) {
  ...
  return (
    <header className="flex items-center gap-3 px-4 h-12 border-b border-[#27272a] bg-[#09090b]/80 backdrop-blur-sm shrink-0 z-20">
      {/* Sidebar toggle */}
      <button
        onClick={onToggleSidebar}
        className="flex items-center justify-center w-7 h-7 rounded-md text-[#52525b] hover:text-[#a1a1aa] hover:bg-[#27272a] transition-all"
          ...
          <>
            ...
            <Link
              ...
              className={cn(
                ...
                isEmailPage ? "text-[#52525b] hover:text-[#a1a1aa]" : "text-[#a1a1aa]"
              )}
            >
              {activeTable.name}
            </Link>
      ...
      <div className="flex items-center gap-1">
        ...
        {/* Help */}
        <button className="flex items-center justify-center w-7 h-7 rounded-md text-[#52525b] hover:text-[#a1a1aa] hover:bg-[#27272a] transition-all text-xs font-mono border border-transparent hover:border-[#27272a]">
          ?
        </button>

        {/* Settings */}
        <button className="flex items-center justify-center w-7 h-7 rounded-md text-[#52525b] hover:text-[#a1a1aa] hover:bg-[#27272a] transition-all border border-transparent hover:border-[#27272a]">
